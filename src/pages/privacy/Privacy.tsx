        ...
        <div className="margin-y-auto">
            ...
            <div className="margin-y-auto fit-content terms-list">
                ...
                <p>
                    ...
                    collect in Splitz. This policy is not applicable to any information collected
                ...
                <h3>Log Files</h3>
                <p>
                    Splitz follows a standard procedure of using log files. These files log visitors
                ...
                <p>
                    ...
                    links that appear on Splitz, which are sent directly to users' browser. They
                ...
                <p>
                    Note that Splitz has no access to or control over these cookies that are used by
                    third-party advertisers.
                </p>
                <h3>Third Party Privacy Policies</h3>
                <p>
                    Splitz's Privacy Policy does not apply to other advertisers or websites. Thus,
                ...
                <p>
                    Splitz does not knowingly collect any Personal Identifiable Information from
