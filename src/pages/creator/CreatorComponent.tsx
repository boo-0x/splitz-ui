...
import {
    metadataReef20Deploy,
    contractsReef20Deploy,
    metadataArtifactReef20Deploy,
} from "./reef20DeployTokenData";
...
const { ComponentCenter, MT, CenterColumn, Margin, CenterRow } = Display;
...
const createToken = async ({
    ...
    try {
        ...
        verified = await verify(
            "0x3E9784368C90e9A4cDC7F8ac711e713468a5F651",
            JSON.stringify(args),
            network
        );
    } catch (err) {
